...
> 3. VSCode
>
> You will also need to have internet access (so no corporate computer) in order to retrieve some of the responses
> that we will be working with from public APIs.
